...
|---|---|---|---|
| [Customer Retention Analysis](https://github.com/DaltySmellsGood/customer-retention-analysis) 🔄 | Analyzed customer retention and purchasing behavior using cohort analysis. | Customer retention declined sharply after acquisition, the highest-spending customer quartile contributed ~80% of total revenue, and monthly revenue nearly doubled from July and November 2011.  | R, SQL, and Power BI |
